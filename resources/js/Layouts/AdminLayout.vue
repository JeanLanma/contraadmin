        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <div>
                ...
                <aside class="bg-white w-60 min-h-screen">
                    <nav class="py-4">
                        <div class="rounded">
                            <a class="block text-gray-500 py-2.5 px-4 mx-2 rounded transition-all duration-300 hover:bg-gray-100" href="#">
                                <span class="flex">
                        ...
                        <div>
                            <a class="block text-gray-500 py-2.5 px-4 ml-2 rounded transition-all duration-300 bg-gray-200" href="#">
                            <!-- <a class="block text-gray-500 py-2.5 px-4 mx-2 rounded transition-all duration-300 hover:bg-gray-100" href="#"> -->
                                <span class="flex">
                                    ...
                                    <span class="ml-4 font-bold">Catalogo</span>
                                </span>
                            </a>
                            <div class="bg-gray-200 ml-2">
                                <a href="#" class="block py-2.5 px-4 ml-2 hover:bg-gray-100">
                                    <div>
                                        <span>Productos</span>
                                    </div>
                                </a>
