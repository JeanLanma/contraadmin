...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <Flicking class="w-full" :options="{ moveType: 'freeScroll', bound: true }">
            <span class="bg-cyan-300 mx-2 py-2 px-4 rounded hover:bg-cyan-400 cursor-pointer">🍎 Apple</span>
            <span class="bg-cyan-300 mx-2 py-2 px-4 rounded hover:bg-cyan-400 cursor-pointer">🍉 Watermelon</span>
            <span class="bg-cyan-300 mx-2 py-2 px-4 rounded hover:bg-cyan-400 cursor-pointer">🥝 Kiwi</span>
            <span class="bg-cyan-300 mx-2 py-2 px-4 rounded hover:bg-cyan-400 cursor-pointer">...</span>
            </Flicking>
