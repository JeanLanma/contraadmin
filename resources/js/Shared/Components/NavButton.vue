...
<button :class="isActive">
    <span class="flex items-center">
        ...
        <span v-if="isIcon(props.icon, 'pencil')" class="mr-1">
            <svg height="24px" width="24px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#374151"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path class="st0" d="M331.736,165.752c-8.792-8.8-23.054-8.784-31.854,0l-13.571,13.587l46.367,46.359l13.578-13.57 c8.784-8.801,8.784-23.071,0-31.872L331.736,165.752z"></path> <path class="st0" d="M256,0C114.84,0,0,114.831,0,256C0,397.152,114.84,512,256,512c141.168,0,256-114.848,256-256 C512,114.831,397.168,0,256,0z M256,466.051c-115.998,0-210.051-94.053-210.051-210.051C45.949,140.002,140.002,45.94,256,45.94 c115.998,0,210.051,94.062,210.051,210.059C466.051,371.998,371.998,466.051,256,466.051z"></path> <polygon class="st0" points="159.164,306.485 159.164,352.845 205.531,352.845 311.352,247.022 264.993,200.664 "></polygon> </g> </g></svg>
        </span>
        {{ props.title }}
    </span>
</button>
